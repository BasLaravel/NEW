...
<div class="container">
  <h3 class="card-title">{{$desktop->title}}</h3>
  <!-- <a class="link" href="#">
  ...
  <div class="row mt-5">
      <div class="col-sm">
        ...
        <ol class="carousel-indicators">
            <li data-target="#carouselExampleIndicators" data-slide-to="0" class="active" ><img class="d-block w-100" src="{{asset($desktop->image_1)}}" style="max-height:60px;"></li>
            <li data-target="#carouselExampleIndicators" data-slide-to="1"><img class="d-block w-100" src="{{asset($desktop->image_2)}}" style="max-height:60px;"></li>
            <li data-target="#carouselExampleIndicators" data-slide-to="2"><img class="d-block w-100" src="{{asset($desktop->image_3)}}" style="max-height:60px;"></li>
          </ol>
          <div class="carousel-inner ">
            <div class="carousel-item active">
              <a href=""><img class="d-block w-100" src="{{$desktop->image_1}}" alt="First slide" style="max-height:270px;"></a>
            </div>
            <div class="carousel-item">
              <a href=""><img class="d-block w-100" src="{{$desktop->image_2}}" alt="Second slide" style="max-height:270px;"></a>
            </div>
            <div class="carousel-item">
              <a href=""><img class="d-block w-100" src="{{$desktop->image_3}}" alt="Third slide" style="max-height:270px;"></a>
            </div>
          </div>
      ...
      <div id="colom2" class="col-sm">
        <ul>
          <!-- <li>Varianten: <select id="selectvar" class="select" name="NL">
            <option value="NL">{{$desktop->summary}}</option>
          </select></li><br> -->
          <!-- <li><div class="price"> -->
